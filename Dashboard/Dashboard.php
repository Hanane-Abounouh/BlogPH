...
<body>
    <div class="flex fixed h-screen ">
            ...
            <div class="flex flex-col flex-1 overflow-y-auto">
                <nav class="flex flex-col flex-1 overflow-y-auto bg-gradient-to-b from-gray-700 to-blue-500 px-2 py-4 gap-10 rounded-2xl">
                    ...
                    <div class="flex flex-col flex-1 gap-3"> 
                        ...
                        <a href="./profil.php" class="sidebar-link flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                        ...
                        <a href="./users.php" class=" sidebar-link flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" style="margin-right: 8px">
                        ...
                        <a href="./comments.php" class="sidebar-link flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="margin-right: 8px">
        ...
        <div class="flex flex-col flex-1 ">
            ...
            <div class="flex w-full  items-center justify-between  h-16 bg-white border-b border-gray-200">
                <div class="flex items-center px-4">
                    ...
                    <div class="relative mx-auto text-gray-600">
                        ...
                        <button type="submit" class="absolute left-0 top-0 mt-3 mr-4">
                            <svg class="text-gray-600 dark:text-gray-200 h-4 w-4 fill-current ml-5"
            ...
            <div class="items-center px-10  justify-center flex flex-col  " id="main-content"></div>
